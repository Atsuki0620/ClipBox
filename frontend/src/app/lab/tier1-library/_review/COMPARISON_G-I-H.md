...
URL: `/lab/tier1-library/variant-g`

![G 全体](./COMPARISON_G-I-H/variant-g.png)

**工夫したパーツ**

KPI を1段に集約し、**判定率をコンパクトな横バー**で可視化（全幅にしない）:
![G KPI](./COMPARISON_G-I-H/crop-g-kpi.png)

**タブ（ライブラリ/ランダム/運命の1本）とフィルタ7項目を1段に統合**（縦スペース節約）:
![G toolbar](./COMPARISON_G-I-H/crop-g-toolbar.png)

**縦に詰めた短いカード**：タイトル2行＋メタ詰め＋D流の3グループ操作:
![G card](./COMPARISON_G-I-H/crop-g-card.png)

レベルは**数値ボタンの単一表現**（未/0–4、アクティブを寒色で強調。バッジ/濃淡ドットは廃止）:
![G level](./COMPARISON_G-I-H/crop-g-level.png)

セクション見出しでグルーピングしたサイドバー（7項目維持・アクティブは塗りピル）:
![G sidebar](./COMPARISON_G-I-H/crop-g-sidebar.png)

---

## Variant I — Data Table Console（最大密度）
URL: `/lab/tier1-library/variant-i`

![I 全体](./COMPARISON_G-I-H/variant-i.png)

**工夫したパーツ**

一覧を**高機能テーブル**化：行選択・**行内 数値レベル**・数値右寄せ・行末"…"メニュー・判定済み行は薄く:
![I table](./COMPARISON_G-I-H/crop-i-table.png)

下部に**ページネーション**（モック）:
![I pager](./COMPARISON_G-I-H/crop-i-pager.png)

---

## Variant H — Library / Bookmark（検索主役）
URL: `/lab/tier1-library/variant-h`

![H 全体](./COMPARISON_G-I-H/variant-h.png)

**工夫したパーツ**

**ヒーロー検索**を主役化（"探す・再発見"）:
![H hero](./COMPARISON_G-I-H/crop-h-hero.png)

レベル/保存先の**フィルタchip**:
![H chips](./COMPARISON_G-I-H/crop-h-chips.png)
