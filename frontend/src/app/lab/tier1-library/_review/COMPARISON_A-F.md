...
- 対象: `frontend/src/app/lab/tier1-library/variant-{a..f}/page.tsx`
- スクリーンショット: `COMPARISON_A-F/variant-{a..f}.png`（Playwright・fullPage・約1580–1600px幅）
...
![Variant A](./COMPARISON_A-F/variant-a.png)
...
![Variant B](./COMPARISON_A-F/variant-b.png)
...
![Variant C](./COMPARISON_A-F/variant-c.png)
...
![Variant D](./COMPARISON_A-F/variant-d.png)
...
![Variant E](./COMPARISON_A-F/variant-e.png)
...
![Variant F](./COMPARISON_A-F/variant-f.png)
